...
const { SESSION_TABLE_NAME, CONNECTION_TABLE_NAME, FILE_BUCKET_NAME, WEBSOCKET_URL } = process.env;
...
exports.handler = async (event, context) => {
  ...
  let message = uploadInitEvent.message;
  let egassem = sessions.test(message);
